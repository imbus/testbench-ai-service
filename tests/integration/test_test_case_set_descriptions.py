...
_PATCH_GET_DESCRIPTION = "testbench_ai_service.usecases.test_case_set_descriptions.service.get_description_for_test_case_set"
_PATCH_PATCH_STARTED = "testbench_ai_service.usecases.test_case_set_descriptions.service.patch_description_generation_started_for_test_structure_element"
_PATCH_PATCH_GENERATED = "testbench_ai_service.usecases.test_case_set_descriptions.service.patch_generated_description_for_test_structure_element"
...
def patches(mocker):
    ...
    return SimpleNamespace(
        ...
        get_description=mocker.patch(
            _PATCH_GET_DESCRIPTION, new_callable=AsyncMock, return_value=""
        ),
...
class TestHappyPath:
    ...
    def test_multiple_items_all_described(self, post, patches):
        ...
        assert patches.patch_generated.call_count == 2  # noqa: PLR2004
        ...
        app.state.config = AppConfig(
            ...
            projects={
                PROJECT_NAME: ProjectConfig(
                    usecases={"test_case_set_descriptions": ProjectUseCaseConfig(enabled=False)}
                )
            },
        )
