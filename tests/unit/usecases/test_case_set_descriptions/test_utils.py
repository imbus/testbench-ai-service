...
class TestGetDescriptionForTestCaseSet(unittest.IsolatedAsyncioTestCase):
    ...
    @patch(
        "testbench_ai_service.usecases.test_case_set_descriptions.utils.strip_html_body_tags",
        return_value="Clean description",
    )
    @patch("testbench_ai_service.usecases.test_case_set_descriptions.utils.TestCaseSetDetails")
...
class TestPatchDescriptionGenerationStarted(unittest.IsolatedAsyncioTestCase):
    ...
    @patch(
        "testbench_ai_service.usecases.test_case_set_descriptions.utils.patch_test_structure_element_spec",
        new_callable=AsyncMock,
    )
    @patch("testbench_ai_service.usecases.test_case_set_descriptions.utils.get_translation")
    @patch("testbench_ai_service.usecases.test_case_set_descriptions.utils.datetime")
...
class TestPatchGeneratedDescription(unittest.IsolatedAsyncioTestCase):
    ...
    @patch(
        "testbench_ai_service.usecases.test_case_set_descriptions.utils.get_translation",
    )
    @patch("testbench_ai_service.usecases.test_case_set_descriptions.utils.datetime")
