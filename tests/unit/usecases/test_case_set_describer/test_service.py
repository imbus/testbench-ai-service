...
class TestTestCaseSetDescriberPrecheck(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_unlocked_tcs_passes_and_is_included(self):
        ...
        with (
            ...
            patch(
                "testbench_ai_service.agents.test_case_set_describer.agent.check_test_case_set_is_locked",
                return_value=False,
            ),
        ):
    ...
    async def test_http_error_is_handled(self):
        ...
        with (
            ...
            patch(
                "testbench_ai_service.agents.test_case_set_describer.agent.handle_requests_http_error"
            ) as mock_handler,
        ):
