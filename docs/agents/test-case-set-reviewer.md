...
The built-in prompt file (`test_case_set_reviewer.yaml`) ships with variants tailored for different test case styles. Each variant specifies the LLM model and review criteria. See [Prompts](../prompts.md) for details on how to customize or create your own variants.
