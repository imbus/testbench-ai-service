...
The built-in prompt file (`defect_explainer.yaml`) ships with variants for different explanation styles. See [Prompts](../prompts.md) for details on how to customize or create your own variants.
