...
|-------------|-------------|
| `agent.step_sequence` | Formatted string representation of the test case set (name, steps, parameters). |
...
|---------|-------|-------------|
| `Full Description` (default) | `gpt-5.4` | Generates a complete description with test objective, verifications, and a summary of each test case. |
| `Short Description` | `gpt-5.1` | Generates a concise one-sentence description stating the test objective only. |
