...
[**TestBench AI Service**](https://github.com/imbus/testbench-ai-service) is an asynchronous REST API service for [imbus TestBench](https://www.testbench.com) that integrates external AI / LLM providers to support multiple AI-driven use cases during test design and test execution.
...
- Exposes a REST API that TestBench calls to trigger AI-driven use cases.
